      ...
      <main className={styles.main}>
        ...
        <section className={styles.hero__container}>
          <div className={styles.hero__text}>
            <h2 className={styles.hero__text__subtitle}>
            ...
            <p className={styles.hero__text__paragraph}>
          ...
          <div className={styles.hero__quote}>
            <blockquote>
              <img src={quote} alt="" />
              <p>
                Officia quaerat itaque, obcaecati ipsam aperiam magni molestiae
                quisquam ad voluptatem sapiente doloremque id soluta suscipit
                veniam? Eligendi, esse. Aperiam, doloremque ad!
              </p>
              <cite className={styles.hero__quotecite}>
                Fulanita de Tal - Cliente
              </cite>
            </blockquote>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <div className={`${styles.section__row} ${styles.section__row2}`}>
            <div
              className={`${styles.section__column} ${styles.section__column1}`}
            >
              <i className={styles.section__icon}>1</i>
            </div>

            <div
              className={`${styles.section__column} ${styles.section__column2}`}
            >
              <a
              ...
              <p className={styles.section__paragraph}>
                ...
                at, magnam quae repellat, repudiandae ipsa nam consequuntur.
              </p>
            </div>

            <div
              className={`${styles.section__column} ${styles.section__column3}`}
            >
        ...
        <section className={styles.sectionregistro}>
          ...
          <article className={styles.sectionregistro__article}>
            <button
              className={styles.sectionregistro__button}
              onClick={() => {
                handleLocalStorage(false);
              }}
            >
